...
| -------------- | ------ | ------------------------------------------ |
| Авто выполнение заданий | Вкл./Выкл. | Выполнение задач |
| Автоматическое выполнение задач колеса | Вкл./Выкл. | Выполнение задач колеса |
| Автоматическа прокрутка колеса| Вкл./Выкл. | Прокрутка колеса для получения награды |
